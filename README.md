...
**AI Engineer & Software Developer** | Building intelligent systems with LLMs, vision, and automation.

I'm passionate about creating practical AI tools that combine **local LLMs**, **multimodal capabilities**, and **clean architecture**. Currently focused on desktop AI agents with persistent memory and vision support.

### 🚀 What I'm Building
- **AI Desktop Agent** — Local + cloud LLMs with vision, long-term memory, and modular tool-calling architecture
- Intelligent automation frameworks (Python + Selenium + AI decision-making)
- Data intelligence pipelines using modern ML tooling
...
**Open to opportunities** in AI tooling, LLM infrastructure, and intelligent automation.
